...
/**
 * Aquesta classe representa una excepció personalitzada per a les operacions d'objectes d'accés a dades (DAO).
 * Amplia la classe Exception i proporciona missatges d'error personalitzats per a diferents tipus d'excepcions.
 */
public class DAOException extends Exception{
    ...
    static {
        ...
        missatges.put(103, "Error al esborrar l'estudiant de la base de dades");
    ...
    //Constructor al que li passem el tipus
    public DAOException(int tipo){
        this.tipo=tipo;
    }

    //Sobreescribim el metode getMessage
    @Override
